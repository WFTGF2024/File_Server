...
public class GlobalExceptionHandler {
    ...
    public Result<Void> handleFileOperationException(FileOperationException e, HttpServletRequest request) {
        log.warn("File operation exception on [{} {}]: code={}, message={}",
                request.getMethod(), request.getRequestURI(), e.getCode(), e.getMessage());
        return Result.error(e.getCode(), e.getMessage());
    }
    ...
    public Result<Void> handleException(Exception e, HttpServletRequest request) {
        log.error("Unexpected exception on [{} {}]", request.getMethod(), request.getRequestURI(), e);
